...
namespace NovaUI.NetCore.Controls
{
	...
	public class NovaSlider : Control
	{
		...
		private readonly Pen trackPen = new(Color.Transparent, 2);
		...
		private void UpdateSlider()
		{
			...
			knobFont = new(Font.Name, knob.Height / 3f);
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			Rectangle slider = new(Height / 2, Height / 4, Width - Height, Height / 2);
