...
using FolderSelectedEventArgs = NovaUI.NetCore.Events.FolderSelectedEventArgs;
using FolderSelectedEventHandler = NovaUI.NetCore.Events.FolderSelectedEventHandler;
		...
		protected override void OnClick(EventArgs e)
		{
			...
			using (FolderBrowserDialog fbd = new()
			{
			...
			}) if (fbd.ShowDialog() == DialogResult.OK)
				{
					...
					if (!input.Text.Equals(old)) OnFolderSelected(new(input.Text));
				}
