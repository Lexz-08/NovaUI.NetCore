...
namespace NovaUI.NetCore.Windows
{
    ...
    public class NovaToolWindow : Form
    {
		...
		protected override void OnPaint(PaintEventArgs e)
		{
            ...
            header = new(0, 0, Width, headerHeight);
            ...
            Rectangle text = new(resizeWidth, resizeWidth - 1, Width - (resizeWidth * 2), headerHeight - (resizeWidth * 2));
            if (ShowIcon)
            {
            ...
            if (ShowIcon)
            {
                ...
                else e.Graphics.FillRectangle(borderBrush, new(resizeWidth, resizeWidth + (useAeroShadow ? 1 : 0) - 1, headerHeight - (resizeWidth * 2), headerHeight - (resizeWidth * 2)));
            }
            ...
            close = new(Width - headerHeight - resizeWidth, resizeWidth, headerHeight, headerHeight - (resizeWidth * 2));
