namespace NovaUI.NetCore.Helpers
{
	public static class ColorHelper
	{
		...
		/// <param name="factor">The factor by which brightness will be modified. (+/- factors lighten or darken respectively)</param>
		...
		public static Color BlendWidth(this Color color1, Color color2)
		{
		...
		internal static SolidBrush ToBrush(this Color color) => new(color);
		...
		internal static Pen ToPen(this Color color) => new(color);
	}
}
